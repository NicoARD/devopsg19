# USE CASE: 8 View All Cities in a Specific Continent by Population Ranking

## CHARACTERISTIC INFORMATION

### Goal in Context
As a Data Analyst, I want to view all cities in a specific continent sorted by largest population to smallest so that I can analyze urban growth in that continent.
...
### Level
Primary task, as this involves querying and sorting city data for a specific continent.
...
A sorted list of all cities in the specified continent by population (largest to smallest) is generated and displayed for the Data Analyst to review.
...
### Trigger
The Data Analyst requests a report for all cities in a specific continent sorted by population, such as during continental urban analysis or in response to an organizational need.

## MAIN SUCCESS SCENARIO
Data Analyst initiates a request to view all cities in a specific continent sorted by population.
...
Data Analyst reviews the report to analyze urban growth in the continent.
...
4a. **No city data available for the continent**:
