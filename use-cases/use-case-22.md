# USE CASE: 22 View Top N Populated Capital Cities in a Specific Region

## CHARACTERISTIC INFORMATION

### Goal in Context
As a Data Analyst, I want to view the top N populated capital cities in a specific region so that I can compare the largest capitals in that area.
...
### Level
Primary task, as this involves querying, sorting, and limiting capital city data for a specific region.

### Preconditions
The SQL database is accessible and contains current capital cities, population, and region data.
The Data Analyst knows the value of N (the number of top capital cities to retrieve) and the name of the specific region.
The Data Analyst has the necessary permissions to query the database.

### Success End Condition
A sorted list of the top N populated capital cities in the specified region (by largest population) is generated and displayed for the Data Analyst to review.
...
### Trigger
The Data Analyst requests a report for the top N populated capital cities in a specific region, such as during regional capital analysis or in response to an organizational need.

## MAIN SUCCESS SCENARIO
Data Analyst initiates a request to view the top N populated capital cities in a specific region.
...
Data Analyst reviews the report to compare the largest capitals in the region.
...
4a. **Fewer capital cities than N in the region**:
