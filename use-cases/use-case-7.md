# USE CASE: 7 View All Cities in the World by Population Ranking

## CHARACTERISTIC INFORMATION

### Goal in Context
As a Data Analyst, I want to view all cities in the world sorted by largest population to smallest so that I can understand global urban population distribution.
...
### Level
Primary task, as this involves querying and sorting city data globally.
...
A sorted list of all cities in the world by population (largest to smallest) is generated and displayed for the Data Analyst to review.
...
### Trigger
The Data Analyst requests a report for all cities sorted by population, such as during global urban analysis or in response to an organizational need.

## MAIN SUCCESS SCENARIO
Data Analyst initiates a request to view all cities sorted by population.
System queries the SQL database to retrieve all city data, including population.
...
Data Analyst reviews the report to understand global urban population distribution.
