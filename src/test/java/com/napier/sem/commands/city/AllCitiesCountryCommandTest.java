...
/**
 * Unit tests for AllCitiesCountryCommand
 */
class AllCitiesCountryCommandTest {

    private AllCitiesCountryCommand command;
    ...
    void setUp() {
        ...
        command = new AllCitiesCountryCommand();
    }

    @Test
    @DisplayName("Should have proper execution command")
    void testExecutionCommand() {
        assertEquals("cities-country", command.getExcecutionCommand());
    }
    ...
    void testCommandDescription() {
        ...
        assertTrue(description.contains("cities") || description.contains("country"));
    }
    ...
    void testExecuteWithValidCountry() throws SQLException {
        ...
        assertDoesNotThrow(() -> {
            command.execute(mockConnection, new String[]{"cities-country", "USA"});
        });
    }
    ...
    void testExecuteWithMissingCountry() {
        assertDoesNotThrow(() -> {
            command.execute(mockConnection, new String[]{"cities-country"});
        });
    }
